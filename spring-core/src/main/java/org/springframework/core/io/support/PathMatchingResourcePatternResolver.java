...
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
	...
	protected Set<Resource> doFindMatchingFileSystemResources(File rootDir, String subPattern) throws IOException {
		// 这里进行进一步的匹配
		// rootDir :H:\github\spring-framework\spring-source-test\bin\com\study\jesse\spring\service
		// subPattern: **/*.class
		if (logger.isTraceEnabled()) {
	...
	protected void doRetrieveMatchingFiles(String fullPattern, File dir, Set<File> result) throws IOException {
		//交给它匹配
		//fullPattern: H:/github/spring-framework/spring-source-test/bin/com/study/jesse/spring/service/**/*.class
		// dir : H:\github\spring-framework\spring-source-test\bin\com\study\jesse\spring\service
		if (logger.isTraceEnabled()) {
