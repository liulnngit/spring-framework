...
import com.study.jesse.spring.service.CombatService;
...
public class JesseApplication {
	...
	public static void main(String[] args) {
		...
		// 注解的方式
		/*ApplicationContext context2 = new AnnotationConfigApplicationContext(JesseApplication.class);
		...
		new ClassPathBeanDefinitionScanner(context3).scan("com.study.jesse.spring.service");
		// 一定要刷新
		context3.refresh();
		...
		/*ApplicationContext context2 = new AnnotationConfigApplicationContext("com.study.jesse.spring.service");
		Abean ab1 = context2.getBean(Abean.class);
		ab1.doSomething();*/
